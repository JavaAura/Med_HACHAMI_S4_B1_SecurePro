...
import com.yc.SecurePro.dto.res.ErrorResponse;
...
public class GlobalExceptionHandler  extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleNoHandlerFoundException(NoHandlerFoundException ex, HttpHeaders headers, HttpStatusCode status, WebRequest request) {
        com.yc.SecurePro.dto.res.ErrorResponse errorRes = new ErrorResponse("404", HttpStatus.NOT_FOUND, "Not found");
    ...
    protected ResponseEntity<Object> handleHttpMessageNotReadable(HttpMessageNotReadableException ex, HttpHeaders headers, HttpStatusCode status, WebRequest request) {
        ...
        ErrorResponse errorRes = new com.yc.SecurePro.dto.res.ErrorResponse("400", HttpStatus.BAD_REQUEST, error);
        return ResponseEntity.badRequest().body(errorRes);
    }
